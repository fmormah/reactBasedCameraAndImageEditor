(function () {
    ...
    app.editImage = function(id,key){

      app.imgId = id;
      app.imgSecretKey = key;
      app.imgDownloadUrl = 'https://clippingmagic.com/api/v1/images/'+app.imgId;
      app.inMobile = false;

      var errorsArray = ClippingMagic.initialize({apiId: 6467});
      ...
      ClippingMagic.edit({
        ...
        "locale" : "en-US"
          ...
          console.log('get edited image');
          console.log(response);
          //app.confirmStage();

          app.capturedImg = app.imgDownloadUrl;
          //$('#uploadForm').submit();
          //app.uploadImageToServer();
          app.picCreate();
    ...
    app.uploadImageToServer = function(){

      $.ajax({
         type: 'POST',
         url: "https://clippingmagic.com/api/v1/images?csrfToken=1530615203196-6642c400bcb76e253b3863fc95c3be6611b04b7d",
    ...
    app.grabImage = function() {
        ...
        function handleImageFromMedia(e) {
            ...
            console.log($('#imageLoader')[0].files);
            reader.onload = function(event) {
                ...
                //app.uploadImageToServer();
                //app.picCreate();
                app.editImage(38274347,'gcamj4enhloopt67bfluf0gfo8qn715c9i865psati3gh8m8jr5');
